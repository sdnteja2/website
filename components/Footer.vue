<template>
  <!-- ========== FOOTER ========== -->
  <footer class="mt-auto bg-gray-700 w-full dark:bg-merah-900">
      ...
      <UDivider class="mb-10">
        <NuxtLink to="/">
          <NuxtImg
            ...
            width="100"
            height="100"
            class="w-32 h-auto  md:w-40 md:h-auto"
          />
        </NuxtLink>
      </UDivider>
      <div class="grid grid-cols-1 md:grid-cols-3  gap-6">
        <div class="col-span-1">
          ...
          <div class="mt-3 grid space-y-3">
            <p><a class="inline-flex gap-x-2 text-gray-50 hover:text-gray-200 focus:outline-none focus:text-gray-200 dark:text-neutral-400 dark:hover:text-neutral-200 dark:focus:text-neutral-200" href="#">Pricing</a></p>
